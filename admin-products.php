        ...
        <div class="CardContainer" id="CardContainer">
            ...
            <script>
                ...
                function createProductCard(product) {
                    ...
                    title.innerHTML = `${product.product_name}`;
                    ...
                    floatInfo.appendChild(price);

                    console.log('Product:', product);
                    console.log('Product Descrption:', product.descripcion);
                    console.log('Product ID', product.idProducto)
                    ...
                    deleteButton.addEventListener('click', function() {
                        ...
                        console.log('Deleting product with ID:', product.idProducto);
                    ...
                    const inputNombre = createHiddenInput('nombre', product.product_name);
                    form.appendChild(inputNombre);

                    
                    // Hidden input for precio
                    const inputPrecio = createHiddenInput('precio', product.precio);
                    form.appendChild(inputPrecio);
                    
                    // Hidden input for descripcion
                    const inputDescripcion = createHiddenInput('descripcion', product.descripcion);
                    form.appendChild(inputDescripcion);
                    
                    // Hidden input for idProducto
                    const inputId =createHiddenInput('idProducto', product.idProducto);
                    ...
                    img.src = "http://localhost/Creative/" + product.img; // Replace with the actual path to your product image
            ...
            <div class="Card">
                <form class="Add" action="add.html" method="post">
